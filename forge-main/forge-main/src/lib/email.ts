...
export async function sendTeamInvitationEmail(
  ...
  return getResendClient().emails.send({
    ...
    text: `Vous êtes invité à rejoindre l’équipe « ${organizationName} ».\n\nRejoignez l’équipe avec ce lien :\n${invitationUrl}\n\nCe lien est personnel et valable pendant 24 heures.`,
    html: renderEmailLayout(
      `<p>Vous êtes invité à rejoindre l’équipe « <strong>${escapeHtml(organizationName)}</strong> ».</p><p>Connectez-vous avec votre compte Forge ou créez-en un pour rejoindre cet espace.</p>{{ACTION}}<p>Ce lien est personnel et valable pendant 24 heures.</p><p>Cordialement,<br/><strong>L’équipe Forge</strong></p>`,
