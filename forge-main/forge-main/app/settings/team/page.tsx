...
export default async function TeamSettingsPage() {
  ...
  return (
    <main className="min-h-dvh px-4 py-8 text-slate-950 dark:text-white sm:px-6">
      <section className="forge-surface mx-auto max-w-xl rounded-[2rem] border border-white/70 bg-white/70 p-6 shadow-xl shadow-slate-200/40 backdrop-blur-xl dark:border-slate-700/70 dark:bg-slate-900/70 dark:shadow-black/20 sm:p-8">
