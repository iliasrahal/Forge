    ...
    <main className="relative isolate min-h-dvh overflow-hidden bg-transparent px-3 py-5 sm:px-6 sm:py-8">
      ...
      <div className="mx-auto w-full max-w-xl">
        ...
        <article className="forge-surface mt-4 rounded-[2rem] border p-4 shadow-xl sm:p-6">
          ...
          <div className="mt-6"><PublicQuoteAcceptance token={token} requiresSignerIdentity={!quote.client} initialAccepted={acceptance.alreadyAccepted} initialSignature={quote.signature} canAccept={acceptance.canAccept} unavailableReason={acceptance.reason} /></div>
